...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Intentar conectar a MongoDB (comentado temporalmente)
        ...
        #     logger.info("📝 Continuando sin MongoDB...")
        ...
        return JSONResponse(
            ...
            content={
                ...
                "servicios": {
                    ...
                    "mongodb": "conectado" if mongodb_service else "no disponible"
                }
            }
        )
    except Exception as e:
...
async def health_check():
    ...
    try:
        ...
        # Verificar MongoDB  
        mongo_ok = mongodb_service is not None

...
# Script de despliegue automático para Cinemax API en EC2 Ubuntu
# Uso: ./scripts/deploy-ec2-ubuntu.sh

set -e  # Salir si hay algún error

echo "🎬 Iniciando despliegue automático de Cinemax API en EC2 Ubuntu..."
...
PROJECT_DIR="/home/ubuntu/cinemax-api"
...
echo ""
echo "🎉 ¡Despliegue en EC2 Ubuntu completado exitosamente!"
echo ""
...
echo "   ✅ Firewall configurado (puertos 22, 80, 443, 3000, 8081, 8082, 9090)"
...
echo "   Actualizar y redeployar: ./scripts/deploy-ec2-ubuntu.sh"
...
success "¡Despliegue en EC2 Ubuntu completado! Tu API de Cinemax está lista para usar en internet."
echo ""
